...
library.init = function(params, callback) {
	...
	app.get('/admin/plugins/enix', middleware.admin.buildHeader, renderAdmin);
	app.get('/api/admin/plugins/enix', renderAdmin);
...
library.getThemeConfig = function(config, callback) {
	...
	meta.settings.get('enix', function(err, settings) {
